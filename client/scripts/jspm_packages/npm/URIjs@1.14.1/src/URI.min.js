  ...
  (function(f, l) {
    ...
    return {
      best: function(g) {
        ...
        var m = g.length,
            b = 8;
        "" === g[0] && "" === g[1] && "" === g[2] ? (g.shift(), g.shift()) : "" === g[0] && "" === g[1] ? g.shift() : "" === g[m - 1] && "" === g[m - 2] && g.pop();
        m = g.length;
        -1 !== g[m - 1].indexOf(".") && (b = 7);
        var k;
        for (k = 0; k < m && "" !== g[k]; k++)
          ;
        if (k < b)
          for (g.splice(k, 1, "0000"); g.length < b; )
            g.splice(k, 0, "0000");
        for (k = 0; k < b; k++) {
          for (var m = g[k].split(""),
              f = 0; 3 > f; f++)
        ...
        var m = -1,
            ...
            r = !1;
        for (k = 0; k < b; k++)
          r ? "0" === g[k] ? l += 1 : (r = !1, l > f && (m = h, f = l)) : "0" === g[k] && (r = !0, h = k, l = 1);
        l > f && (m = h, f = l);
        1 < f && g.splice(m, f, "");
        m = g.length;
        b = "";
  ...
  (function(f) {
    ...
    function b(b) {
      for (var e = [],
          ...
          c,
          d; h < a; )
        c = b.charCodeAt(h++), 55296 <= c && 56319 >= c && h < a ? (d = b.charCodeAt(h++), 56320 == (d & 64512) ? e.push(((c & 1023) << 10) + (d & 1023) + 65536) : (e.push(c), h--)) : e.push(c);
      return e;
    }
    function k(b) {
      return g(b, function(b) {
        var e = "";
        65535 < b && (b -= 65536, e += A(b >>> 10 & 1023 | 55296), b = 56320 | b & 1023);
        return e += A(b);
      }).join("");
    }
    function y(b, e) {
    ...
    function p(b, e, h) {
      var a = 0;
      b = h ? q(b / 700) : b >> 1;
      for (b += q(b / e); 455 < b; a += 36)
        b = q(b / 35);
      return q(a + 36 * b / (b + 38));
    }
    function h(b) {
      var e = [],
          h = b.length,
      ...
      0 > w && (w = 0);
      for (x = 0; x < w; ++x)
        128 <= b.charCodeAt(x) && l("not-basic"), e.push(b.charCodeAt(x));
      for (w = 0 < w ? w + 1 : 0; w < h; ) {
        x = c;
        a = 1;
        for (g = 36; ; g += 36) {
          ...
          (36 <= f || f > q((2147483647 - c) / a)) && l("overflow");
          c += f * a;
          m = g <= t ? 1 : g >= t + 26 ? 26 : g - t;
          if (f < m)
            break;
          f = 36 - m;
          a > q(2147483647 / f) && l("overflow");
          a *= f;
        }
        a = e.length + 1;
        t = p(c - x, a, 0 == x);
        q(c / a) > 2147483647 - d && l("overflow");
        d += q(c / a);
        c %= a;
        e.splice(c++, 0, d);
      }
    ...
    function r(e) {
      ...
      d = 72;
      for (t = 0; t < r; ++t)
        f = e[t], 128 > f && m.push(A(f));
      for ((a = c = m.length) && m.push("-"); a < r; ) {
        w = 2147483647;
        for (t = 0; t < r; ++t)
          f = e[t], f >= h && f < w && (w = f);
        k = a + 1;
        w - h > q((2147483647 - g) / k) && l("overflow");
        g += (w - h) * k;
        h = w;
        for (t = 0; t < r; ++t)
          if (f = e[t], f < h && 2147483647 < ++g && l("overflow"), f == h) {
            x = g;
            for (w = 36; ; w += 36) {
              f = w <= d ? 1 : w >= d + 26 ? 26 : w - d;
              if (x < f)
                break;
              n = x - f;
              x = 36 - f;
    ...
    var B = "object" == typeof exports && exports,
        ...
        z = "object" == typeof global && global;
    if (z.global === z || z.window === z)
      f = z;
    var s,
        n = /^xn--/,
        e = /[^ -~]/,
    ...
    var l = f && f.SecondLevelDomains,
        g = {
          ...
          has: function(f) {
            ...
            if (0 >= k || k >= b - 1)
              return !1;
            var l = g.list[f.slice(b + 1)];
            return l ? 0 <= l.indexOf(" " + f.slice(k + 1, b) + " ") : !1;
          },
          is: function(f) {
            var b = f.lastIndexOf(".");
            if (0 >= b || b >= f.length - 1 || 0 <= f.lastIndexOf(".", b - 1))
              return !1;
            var k = g.list[f.slice(b + 1)];
          ...
          get: function(f) {
            ...
            if (0 >= k || k >= b - 1)
              return null;
            var l = g.list[f.slice(b + 1)];
            return !l || 0 > l.indexOf(" " + f.slice(k + 1, b) + " ") ? null : f.slice(k + 1);
          },
          noConflict: function() {
            f.SecondLevelDomains === this && (f.SecondLevelDomains = l);
            return this;
          }
        };
    return g;
  ...
  (function(f, l) {
    ...
    function h(a, c) {
      ...
      for (b = a.length; d < b; d++)
        if ("RegExp" === e) {
          if ("string" === typeof a[d] && a[d].match(c))
            return !0;
        } else if (a[d] === c)
          return !0;
      return !1;
    ...
    b.recodePath = function(a) {
      ...
      for (var c = 0,
          d = a.length; c < d; c++)
        a[c] = b.encodePathSegment(b.decode(a[c]));
      return a.join("/");
    };
    ...
    for (q in v)
      b[q + "PathSegment"] = A("pathname", v[q]);
    b.encodeReserved = A("reserved", "encode");
    ...
    b.parseHost = function(a, c) {
      var d = a.indexOf("/"),
          b;
      -1 === d && (d = a.length);
      "[" === a.charAt(0) ? (b = a.indexOf("]"), c.hostname = a.substring(1, b) || null, c.port = a.substring(b + 2, d) || null, "/" === c.port && (c.port = null)) : a.indexOf(":") !== a.lastIndexOf(":") ? (c.hostname = a.substring(0, d) || null, c.port = null) : (b = a.substring(0, d).split(":"), c.hostname = b[0] || null, c.port = b[1] || null);
    ...
    b.parseUserinfo = function(a, c) {
      var d = a.indexOf("/"),
          t = a.lastIndexOf("@", -1 < d ? d : a.length - 1);
      -1 < t && (-1 === d || t < d) ? (d = a.substring(0, t).split(":"), c.username = d[0] ? b.decode(d[0]) : null, d.shift(), c.password = d[0] ? b.decode(d.join(":")) : null, a = a.substring(t + 1)) : (c.username = null, c.password = null);
      return a;
    };
    b.parseQuery = function(a, c) {
      ...
      for (var d = {},
          ...
          h,
          g = 0; g < e; g++)
        f = t[g].split("="), h = b.decodeQuery(f.shift(), c), f = f.length ? b.decodeQuery(f.join("="), c) : null, u.call(d, h) ? ("string" === typeof d[h] && (d[h] = [d[h]]), d[h].push(f)) : d[h] = f;
      return d;
    };
    b.build = function(a) {
      var c = "";
    ...
    b.buildQuery = function(a, c, d) {
      ...
      for (f in a)
        if (u.call(a, f) && f)
          if (p(a[f]))
            for (e = {}, h = 0, g = a[f].length; h < g; h++)
              void 0 !== a[f][h] && void 0 === e[a[f][h] + ""] && (t += "&" + b.buildQueryParameter(f, a[f][h], d), !0 !== c && (e[a[f][h] + ""] = !0));
          else
            void 0 !== a[f] && (t += "&" + b.buildQueryParameter(f, a[f], d));
    ...
    b.addQuery = function(a, c, d) {
      if ("object" === typeof c)
        for (var e in c)
          u.call(c, e) && b.addQuery(a, e, c[e]);
      else if ("string" === typeof c)
        void 0 === a[c] ? a[c] = d : ("string" === typeof a[c] && (a[c] = [a[c]]), p(d) || (d = [d]), a[c] = (a[c] || []).concat(d));
      else
    ...
    b.removeQuery = function(a, c, d) {
      ...
      if (p(c))
        ...
        for (e in c)
          u.call(c, e) && b.removeQuery(a, e, c[e]);
      else if ("string" === typeof c)
        if (void 0 !== d)
          if (a[c] === d)
            a[c] = void 0;
    ...
    b.hasQuery = function(a, c, d, e) {
      if ("object" === typeof c) {
        for (var f in c)
          if (u.call(c, f) && !b.hasQuery(a, f, c[f]))
            return !1;
        return !0;
      }
      if ("string" !== typeof c)
      ...
      switch (y(d)) {
        case "Undefined":
          return c in a;
        case "Boolean":
          return a = Boolean(p(a[c]) ? a[c].length : a[c]), d === a;
        case "Function":
          return !!d(a[c], c, a);
        case "Array":
          return p(a[c]) ? (e ? h : r)(a[c], d) : !1;
        case "RegExp":
          return p(a[c]) ? e ? h(a[c], d) : !1 : Boolean(a[c] && a[c].match(d));
        case "Number":
          d = String(d);
        case "String":
          return p(a[c]) ? e ? h(a[c], d) : !1 : a[c] === d;
        default:
    ...
    b.withinString = function(a, c, d) {
      ...
      for (e.lastIndex = 0; ; ) {
        ...
        var k = r + a.slice(r).search(f),
            m = a.slice(r, k).replace(h, "");
        d.ignore && d.ignore.test(m) || (k = r + m.length, m = c(m, r, k, a), a = a.slice(0, r) + m + a.slice(k), e.lastIndex = r + m.length);
      }
      e.lastIndex = 0;
      return a;
    };
    ...
    b.noConflict = function(a) {
      if (a)
        return a = {URI: this.noConflict()}, m.URITemplate && "function" === typeof m.URITemplate.noConflict && (a.URITemplate = m.URITemplate.noConflict()), m.IPv6 && "function" === typeof m.IPv6.noConflict && (a.IPv6 = m.IPv6.noConflict()), m.SecondLevelDomains && "function" === typeof m.SecondLevelDomains.noConflict && (a.SecondLevelDomains = m.SecondLevelDomains.noConflict()), a;
      m.URI === this && (m.URI = n);
      return this;
    };
    e.build = function(a) {
    ...
    e.protocol = z("protocol");
    e.username = z("username");
    e.password = z("password");
    e.hostname = z("hostname");
    e.port = z("port");
    e.query = s("query", "?");
    e.fragment = s("fragment", "#");
    e.search = function(a, c) {
      var d = this.query(a, c);
      return "string" === typeof d && d.length ? "?" + d : d;
    };
    e.hash = function(a, c) {
      var d = this.fragment(a, c);
      return "string" === typeof d && d.length ? "#" + d : d;
    };
    ...
    e.href = function(a, c) {
      ...
      if ("string" === typeof a || a instanceof String)
        ...
        for (d in e = e ? a._parts : a, e)
          u.call(this._parts, d) && (this._parts[d] = e[d]);
      else
    ...
    e.is = function(a) {
      var c = !1,
          ...
          k = !1,
          m = !this._parts.urn;
      this._parts.hostname && (m = !1, d = b.ip4_expression.test(this._parts.hostname), e = b.ip6_expression.test(this._parts.hostname), c = d || e, h = (f = !c) && g && g.has(this._parts.hostname), r = f && b.idn_expression.test(this._parts.hostname), k = f && b.punycode_expression.test(this._parts.hostname));
    ...
    e.protocol = function(a, c) {
      if (void 0 !== a && a && (a = a.replace(/:(\/\/)?$/, ""), !a.match(b.protocol_expression)))
    ...
    e.domain = function(a, c) {
      ...
      !this._parts.hostname || this.is("IP") ? this._parts.hostname = a : (d = new RegExp(k(this.domain()) + "$"), this._parts.hostname = this._parts.hostname.replace(d, a));
      this.build(!c);
      return this;
    };
    e.tld = function(a, c) {
      ...
      if (a)
        if (a.match(/[^a-zA-Z0-9-]/))
          if (g && g.is(a))
            d = new RegExp(k(this.tld()) + "$"), this._parts.hostname = this._parts.hostname.replace(d, a);
          else
            throw new TypeError('TLD "' + a + '" contains characters other than [A-Z0-9]');
        else {
          if (!this._parts.hostname || this.is("IP"))
            throw new ReferenceError("cannot set TLD on non-domain host");
          d = new RegExp(k(this.tld()) + "$");
          this._parts.hostname = this._parts.hostname.replace(d, a);
        }
      else
    ...
    e.filename = function(a, c) {
      ...
      a.match(/\.?\//) && (d = !0);
      var e = new RegExp(k(this.filename()) + "$");
      a = b.recodePath(a);
    ...
    e.suffix = function(a, c) {
      ...
      "." === a.charAt(0) && (a = a.substring(1));
      if (d = this.suffix())
        e = a ? new RegExp(k(d) + "$") : new RegExp(k("." + d) + "$");
      else {
        if (!a)
          return this;
    ...
    e.segment = function(a, c, d) {
      ...
      if (null === a || void 0 === e[a])
        if (p(c)) {
          e = [];
          a = 0;
          for (var h = c.length; a < h; a++)
            if (c[a].length || e.length && e[e.length - 1].length)
              e.length && !e[e.length - 1].length && e.pop(), e.push(c[a]);
        } else {
    ...
    e.query = function(a, c) {
      ...
      return void 0 !== a && "string" !== typeof a ? (this._parts.query = b.buildQuery(a, this._parts.duplicateQueryParameters, this._parts.escapeQuerySpace), this.build(!c), this) : G.call(this, a, c);
    };
    ...
    e.normalizeHostname = function(a) {
      this._parts.hostname && (this.is("IDN") && f ? this._parts.hostname = f.toASCII(this._parts.hostname) : this.is("IPv6") && l && (this._parts.hostname = l.best(this._parts.hostname)), this._parts.hostname = this._parts.hostname.toLowerCase(), this.build(!a));
      return this;
    };
    ...
    e.normalizePath = function(a) {
      ...
      for (; ; ) {
        ...
        h = d.substring(0, f).lastIndexOf("/");
        -1 === h && (h = f);
        d = d.substring(0, h) + d.substring(f + 3);
      }
      c && this.is("relative") && (d = e + d.substring(1));
      d = b.recodePath(d);
      this._parts.path = d;
      this.build(!a);
      return this;
    ...
    e.normalizeQuery = function(a) {
      "string" === typeof this._parts.query && (this._parts.query.length ? this.query(b.parseQuery(this._parts.query, this._parts.escapeQuerySpace)) : this._parts.query = null, this.build(!a));
      return this;
    };
    ...
    e.readable = function() {
      ...
      if (a._parts.query) {
        for (var d = "",
            e = 0,
            h = a._parts.query.split("&"),
            g = h.length; e < g; e++) {
          var r = (h[e] || "").split("="),
              d = d + ("&" + b.decodeQuery(r[0], this._parts.escapeQuerySpace).replace(/&/g, "%26"));
          void 0 !== r[1] && (d += "=" + b.decodeQuery(r[1], this._parts.escapeQuerySpace).replace(/&/g, "%26"));
        }
        c += "?" + d.substring(1);
      }
    ...
    e.equals = function(a) {
      ...
      c.query("");
      a.query("");
      if (c.toString() !== a.toString() || d.length !== e.length)
        return !1;
  ...
  (function(f, l) {
    ...
    g.expand = function(b, f) {
      var k = p[b.operator],
          ...
          u;
      for (u = 0; e = l[u]; u++)
        n = f.get(e.name), n.val.length ? s.push(g["expand" + m](n, k, e.explode, e.explode && k.separator || ",", e.maxlength, e.name)) : n.type && s.push("");
      return s.length ? k.prefix + s.join(k.separator) : "";
    };
    g.expandNamed = function(b, g, k, m, l, s) {
      var n = "",
          e = g.encode;
      ...
      var u = !b[e].length,
          ...
          y;
      p = 0;
      for (y = b.val.length; p < y; p++)
        l ? (q = f[e](b.val[p][1].substring(0, l)), 2 === b.type && (v = f[e](b.val[p][0].substring(0, l)))) : u ? (q = f[e](b.val[p][1]), 2 === b.type ? (v = f[e](b.val[p][0]), b[e].push([v, q])) : b[e].push([void 0, q])) : (q = b[e][p][1], 2 === b.type && (v = b[e][p][0])), n && (n += m), k ? n += v + (g || q ? "=" : "") + q : (p || (n += f[e](s) + (g || q ? "=" : "")), 2 === b.type && (n += v + ","), n += q);
      return n;
    };
    g.expandUnnamed = function(b, g, k, m, l) {
      ...
      var e = !b[n].length,
          ...
          y;
      q = 0;
      for (y = b.val.length; q < y; q++)
        l ? v = f[n](b.val[q][1].substring(0, l)) : e ? (v = f[n](b.val[q][1]), b[n].push([2 === b.type ? f[n](b.val[q][0]) : void 0, v])) : v = b[n][q][1], s && (s += m), 2 === b.type && (p = l ? f[n](b.val[q][0].substring(0, l)) : b[n][q][0], s += p, s = k ? s + (g || v ? "=" : "") : s + ","), s += v;
      return s;
    };
    g.noConflict = function() {
      l.URITemplate === g && (l.URITemplate = b);
      return g;
    };
    y.expand = function(b) {
      var f = "";
      ...
      for (var k = 0,
          l = this.parts.length; k < l; k++)
        f += "string" === typeof this.parts[k] ? this.parts[k] : g.expand(this.parts[k], b);
      return f;
    };
    y.parse = function() {
      ...
      for (f.lastIndex = 0; ; ) {
        e = f.exec(b);
        if (null === e) {
          l.push(b.substring(s));
          break;
        } else
          l.push(b.substring(s, e.index)), s = e.index + e[0].length;
        if (!p[e[1]])
          throw Error('Unknown Operator "' + e[1] + '" in "' + e[0] + '"');
        if (!e[3])
          throw Error('Unclosed Expression "' + e[0] + '"');
        n = e[2].split(",");
        for (var v = 0,
            q = n.length; v < q; v++) {
          u = n[v].match(k);
          if (null === u)
            throw Error('Invalid Variable "' + n[v] + '" in "' + e[0] + '"');
          if (u[1].match(m))
            throw Error('Invalid Variable Name "' + u[1] + '" in "' + e[0] + '"');
          n[v] = {
            name: u[1],
            explode: !!u[3],
            maxlength: u[4] && parseInt(u[4], 10)
          };
        }
        if (!n.length)
          throw Error('Expression Missing Variable(s) "' + e[0] + '"');
        l.push({
          expression: e[0],
          operator: e[1],
          variables: n
      ...
      if (void 0 !== f && null !== f)
        if ("[object Array]" === String(Object.prototype.toString.call(f))) {
          ...
          for (b = f.length; l < b; l++)
            void 0 !== f[l] && null !== f[l] && g.val.push([void 0, String(f[l])]);
          g.val.length && (g.type = 3);
        } else if ("[object Object]" === String(Object.prototype.toString.call(f))) {
          for (l in f)
            k.call(f, l) && void 0 !== f[l] && null !== f[l] && g.val.push([l, String(f[l])]);
          g.val.length && (g.type = 2);
        } else
          g.type = 1, g.val.push([void 0, String(f)]);
      return g;
    };
    f.expand = function(b, k) {
      var l = (new g(b)).expand(k);
      return new f(l);
    };
    return g;
  });
